...
export default function Docs() {
  ...
  const languages = [
    { code: 'yor', name: 'Yoruba', region: 'Nigeria' },
    { code: 'ibo', name: 'Igbo', region: 'Nigeria' },
    { code: 'hau', name: 'Hausa', region: 'Nigeria' },
    { code: 'swa', name: 'Swahili', region: 'East Africa' },
    { code: 'amh', name: 'Amharic', region: 'Ethiopia' },
    { code: 'zul', name: 'Zulu', region: 'South Africa' },
    { code: 'xho', name: 'Xhosa', region: 'South Africa' },
    { code: 'twi', name: 'Twi', region: 'Ghana' },
    { code: 'wol', name: 'Wolof', region: 'Senegal' },
    { code: 'orm', name: 'Oromo', region: 'Ethiopia' }
  ];
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {languages.map((lang) => (
                  <div key={lang.code} className="flex items-center p-3 border rounded-md">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Code: <code>{lang.code}</code> • Region: {lang.region}
                      </p>
                    </div>
                  </div>
                ))}

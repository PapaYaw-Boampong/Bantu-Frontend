                  ...
                  <CardContent className="space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                       ...
                       {/* Thresholds */}
                       <div className="space-y-4">
                      <h3 className="text-lg font-medium">Reward Thresholds</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* <div className="space-y-2">
                          <Label htmlFor="target_contribution_count">Target Contributions</Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="threshold_point_count">Threshold Points</Label>
                          <Input
                            id="target_contribution_count"
                            type="number"
                            value={formData.target_contribution_count}
                            onChange={(e) => handleDirectChange('threshold_point_count', e.target.value)}
                            placeholder="min points needed for reward"
                            className={formErrors.target_contribution_count ? 'border-red-500' : ''}
                          />
                          {formErrors.target_contribution_count && (
                            <p className="text-sm text-red-500">{formErrors.target_contribution_count}</p>
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="target_contribution_count">Threshold Participants</Label>
                          <Input
                            id="target_contribution_count"
                            type="number"
                            value={formData.target_contribution_count}
                            onChange={(e) => handleDirectChange('threshold_participant_count', e.target.value)}
                            placeholder="Enter target number"
                            className={formErrors.target_contribution_count ? 'border-red-500' : ''}
                          />
                          {formErrors.target_contribution_count && (
